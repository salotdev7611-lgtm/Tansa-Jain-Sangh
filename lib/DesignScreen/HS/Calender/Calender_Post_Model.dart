...
//     month: json["month"] != null && monthValues.map.containsKey(json["month"])
//         ? monthValues.map[json["month"]]
//         : null,
//     tithi: json["tithi"],
//     suryoday: json["suryoday"],
//     suryast: json["Suryast"] ?? json["suryast"],
...
CalenderPostModel calenderPostModelFromJson(String str) =>
    CalenderPostModel.fromJson(json.decode(str));

String calenderPostModelToJson(CalenderPostModel data) =>
...
class CalenderPostModel {
  ...
  factory CalenderPostModel.fromJson(Map<String, dynamic> json) =>
      CalenderPostModel(
        success: json["success"],
        errorMsg: json["errorMsg"],
        data: json["data"] == null
...
class Datum {
  DateTime? date;
  String? month; // ✅ CHANGED (IMPORTANT)
  String? tithi;
  String? suryoday;
  String? suryast;
  String? navkarshi;
